...
@Component
public class CreditCardRule implements RecommendationRule {

  private final ProductRepository productRepository;

  public CreditCardRule(ProductRepository productRepository) {
  ...
  public Optional<Product> validate(CustomerDto customerDto) {
    if (customerDto.getAge() > 17
      ...
      return Optional.ofNullable(productRepository.findByName("Credit Card"));
    }
